...
func initializeRouter() {
	...
	alertHook.HandleFunc("/idpatient/{id}/", GetAlertByPatientID).Methods("GET")
	...
	caretakerHook.HandleFunc("/patientscount/{id}/", GetPatientsCountCaretakers).Methods("GET")
	...
	medicalFileHook.HandleFunc("/idpatient/{id}/", GetMedicalFileByPatientID).Methods("GET")
	...
	medicHook := r.PathPrefix("/api/medic").Subrouter()
